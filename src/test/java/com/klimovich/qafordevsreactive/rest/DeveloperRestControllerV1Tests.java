package com.klimovich.qafordevsreactive.rest;

import com.klimovich.qafordevsreactive.dto.DeveloperDto;
...
import com.klimovich.qafordevsreactive.service.DeveloperService;
import com.klimovich.qafordevsreactive.util.DataUtils;
...
@ComponentScan({"com.klimovich.qafordevsreactive.errorhandling"})
...
public class DeveloperRestControllerV1Tests {
    ...
    public void givenDeveloperDto_whenCreateDeveloper_thenSuccessResponse() {
        ...
        BDDMockito.given(developerService.createDeveloper(any(DeveloperEntity.class))).willReturn(Mono.just(entity));
        //when
    ...
    public void givenDeveloperDto_whenUpdateDeveloper_thenSuccessResponse() {
        ...
        DeveloperEntity entity = DataUtils.getJohnDoePersisted();
        BDDMockito.given(developerService.updateDeveloper(any(DeveloperEntity.class))).willReturn(Mono.just(entity));
        //when
    ...
    public void givenThreeDevelopers_whenGetAll_thenDevelopersAreReturned() {
        //given
        ...
        BDDMockito.given(developerService.getAll()).willReturn(Flux.just(entity1, entity2, entity3));
        //when
    ...
    public void givenId_whenGetById_thenDeveloperIsReturned() {
        ...
        BDDMockito.given(developerService.getById(anyInt())).willReturn(Mono.just(entity));
        //when
        WebTestClient.ResponseSpec result = webTestClient.get()
